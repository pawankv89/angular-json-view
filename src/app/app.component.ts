...
export class AppComponent {
  title = 'angular-json-view';
  get loadData(){
    return this.convertJsonToViewer(this.bookData);
  }

  convertJsonToViewer(data: any) {
    let library: any = {};
    library.json = {
      replacer: function (match: any, pIndent: any, pKey: any, pVal: any, pEnd: any) {
        const key = '<span class=json-key>';
        const val = '<span class=json-value>';
        const valNull = '<span class=json-value-null>';
        const valNumber = '<span class=json-value-number>';
        ...
        if (pVal) {
          ...
          } else if (pVal === 'true' || pVal === 'false' || pVal === 'TRUE' || pVal === 'FALSE') {
            r = r + val + pVal + '</span>';
          } else {
            r = r + (pVal[0] == '"' ? str : valNumber) + pVal + '</span>';
          }
        }
        return r + (pEnd || '');
      },
